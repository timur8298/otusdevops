...
По ссылке следует авторизоваться по полученным имени и паролю, создать в гитлабе группу (timur8298) и проекты в группе (monitoring, search_engine_ui, search_engine_crawler, search_engine_deploy). В группе (timur8298)
Все проекты (search_engine_ui, search_engine_crawler, search_engine_deploy, monitoring) в папке src запушить в гитлаб:
cd/src/%project%
git init
